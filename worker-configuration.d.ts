/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 594aaafdcc67d6b9b6ef13cb09bd6fb1)
// Runtime types generated with workerd@1.20251210.0 2025-12-10 nodejs_compat_v2
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "BoardDO" | "Sandbox" | "UserDO" | "RoadmapDO" | "BugBoardDO";
	}
	interface Env {
		AUTH_MODE: "none";
		USER_ID: "dev-user" | "user";
		USER_EMAIL: "dev@localhost" | "user@localhost";
		...
		ROADMAP_DO: DurableObjectNamespace<import("./worker/index").RoadmapDO>;
		BUGBOARD_DO: DurableObjectNamespace<import("./worker/index").BugBoardDO>;
